...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="form-group">
        ...
        <div class="col-sm-3">
							 <asp:TextBox ID="txtSearch" placeholder="ابحث بعنوان اللجنة" runat="server" CssClass="form-control"></asp:TextBox>
            </div>
								<div class="col-sm-3">
    ...
    <div class="form-group">
                        <div class="col-sm-12">
                                 <asp:GridView ID="gvMeeting" runat="server" CssClass="table-striped table" Font-Size="Small" AllowPaging="True" AllowSorting="True" AutoGenerateDeleteButton="True" AutoGenerateEditButton="True" AutoGenerateSelectButton="True" CellPadding="4" ForeColor="Black" OnRowDataBound="gvMeeting_RowDataBound" OnRowDeleting="gvMeeting_RowDeleting" OnSelectedIndexChanged="gvMeeting_SelectedIndexChanged" OnPageIndexChanging="gvMeeting_PageIndexChanging" OnRowEditing="gvMeeting_RowEditing" OnSelectedIndexChanging="gvMeeting_SelectedIndexChanging" OnSorting="gvMeeting_Sorting" >
